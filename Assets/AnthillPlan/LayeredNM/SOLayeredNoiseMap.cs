...
namespace AnthillPlan.LayeredNM {
    ...
    /// <summary>
    /// This Scriptable object is used to hold and interface with the LayeredNoiseMap Graphs.
    /// </summary>
    [CreateAssetMenu]
    public class SOLayeredNoiseMap : ScriptableObject {
        ...
        private List<RuntimeVariable> runtimeGraphBlackboardVariables;
        ...
        public void RunGraph() {
            //Debug.Log($"SOLayeredNoiseMap RunGraph");
            OnValidate();
